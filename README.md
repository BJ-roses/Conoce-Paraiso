...
<head>
    ...
    <title>Descubre Paraíso, Costa Rica</title>
    <link rel="stylesheet" href="styles.css"> <!-- Puedes agregar estilos aquí -->
    <style>
        body {
        ...
        img {
            ...
            border-radius: 5px; /* Opcional: agrega bordes redondeados a la imagen */
        }
        footer {
            text-align: center;
            padding: 20px;
...
<div class="container">
    <section id="restaurantes">
        ...
        <div class="card">
            ...
            <img src="https://lh3.googleusercontent.com/p/AF1QipPDeqgoi6JMi4Pkl97sbGFfWEfId0Oxgy-Q1ZS3=s1360-w1360-h1020" alt="Il Giardino - Pizzeria a la leña" />
